...
(this.define || function (K, O) {
  ...
  (function h(r, m, e) {
    ...
    for (var v = "function" == typeof require && require, A = 0; A < e.length; A++)p(e[A]);
    return p
  })({
    1: [function (h,
                  r, m) {
    ...
    3: [function (h, r, m) {
      function e(f, n, x) {
        if (!(this instanceof e))return new e(f, n, x);
        var a = typeof f;
        if ("base64" === n && "string" === a)for (f = f.trim ? f.trim() : f.replace(/^\s+|\s+$/g, ""); 0 !== f.length % 4;)f += "=";
        var b;
        if ("number" === a) b = w(f); else if ("string" === a) b = e.byteLength(f, n); else if ("object" === a) b = w(f.length); else throw Error("First argument needs to be a number, array or string.");
        var c;
        e._useTypedArrays ? c = e._augment(new Uint8Array(b)) :
          (c = this, c.length = b, c._isBuffer = !0);
        if (e._useTypedArrays && "number" === typeof f.byteLength) c._set(f); else {
          var d = f;
          if (y(d) || e.isBuffer(d) || d && "object" === typeof d && "number" === typeof d.length)for (n = 0; n < b; n++)e.isBuffer(f) ? c[n] = f.readUInt8(n) : c[n] = f[n]; else if ("string" === a) c.write(f, 0, n); else if ("number" === a && !e._useTypedArrays && !x)for (n = 0; n < b; n++)c[n] = 0
        }
        return c
      }
      ...
      function p(f, n, x) {
        var a = "";
        for (x = Math.min(f.length, x); n < x; n++)a += String.fromCharCode(f[n]);
        return a
      }

      function v(f, n, x, a) {
        a || (q("boolean" === typeof x,
          "missing or invalid endian"), q(void 0 !== n && null !== n, "missing offset"), q(n + 1 < f.length, "Trying to read beyond buffer length"));
        a = f.length;
        if (!(n >= a))return x ? (x = f[n], n + 1 < a && (x |= f[n + 1] << 8)) : (x = f[n] << 8, n + 1 < a && (x |= f[n + 1])), x
      }
      ...
      function A(f, n, a, c) {
        ...
        if (!(n >= c)) {
          var b;
          a ? (n + 2 < c && (b = f[n + 2] << 16), n + 1 < c && (b |= f[n + 1] << 8), b |= f[n], n + 3 < c && (b += f[n + 3] << 24 >>> 0)) :
            (n + 1 < c && (b = f[n + 1] << 16), n + 2 < c && (b |= f[n + 2] << 8), n + 3 < c && (b |= f[n + 3]), b += f[n] << 24 >>> 0);
          return b
        }
      }
      ...
      function g(f, n, a, b) {
        ...
        if (!(n >= f.length))return f = v(f, n, a, !0), f & 32768 ? -1 * (65535 - f + 1) : f
      }
      ...
      function d(f, n, a, b) {
        ...
        if (!(n >=
          f.length))return f = A(f, n, a, !0), f & 2147483648 ? -1 * (4294967295 - f + 1) : f
      }
      ...
      function c(f, n, a, b, c) {
        c || (q(void 0 !== n && null !== n, "missing value"), q("boolean" === typeof b, "missing or invalid endian"), q(void 0 !==
          a && null !== a, "missing offset"), q(a + 1 < f.length, "trying to write beyond buffer length"), L(n, 65535));
        var d = f.length;
        if (!(a >= d))for (c = 0, d = Math.min(d - a, 2); c < d; c++)f[a + c] = (n & 255 << 8 * (b ? c : 1 - c)) >>> 8 * (b ? c : 1 - c)
      }
      ...
      function a(f, n, a, b, c) {
        ...
        var d = f.length;
        if (!(a >= d))for (c = 0, d = Math.min(d - a, 4); c < d; c++)f[a + c] = n >>>
          8 * (b ? c : 3 - c) & 255
      }
      ...
      function z(f, n, b, c, d) {
        d || (q(void 0 !== n && null !== n, "missing value"), q("boolean" === typeof c, "missing or invalid endian"), q(void 0 !== b && null !== b, "missing offset"), q(b + 3 < f.length, "Trying to write beyond buffer length"),
          M(n, 2147483647, -2147483648));
      ...
      function B(f, n, a, b, c) {
        c || (q(void 0 !== n && null !== n, "missing value"), q("boolean" === typeof b, "missing or invalid endian"),
          q(void 0 !== a && null !== a, "missing offset"), q(a + 7 < f.length, "Trying to write beyond buffer length"), N(n, 1.7976931348623157E308, -1.7976931348623157E308));
        a >= f.length || I.write(f, n, a, b, 52, 8)
      }

      function E(f, a, b) {
        if ("number" !== typeof f)return b;
        f = ~~f;
        if (f >= a)return a;
        if (0 <= f)return f;
        f += a;
      ...
      function t(f) {
        for (var a = [], b = 0; b < f.length; b++) {
          ...
          if (127 >= c) a.push(f.charCodeAt(b)); else {
            var d = b;
            55296 <= c && 57343 >= c && b++;
            c = encodeURIComponent(f.slice(d, b + 1)).substr(1).split("%");
            for (d = 0; d < c.length; d++)a.push(parseInt(c[d], 16))
          }
        }
        return a
      }
      ...
      function F(f) {
        for (var a = [], b = 0; b < f.length; b++)a.push(f.charCodeAt(b) & 255);
        return a
      }

      function C(f, a, b, c) {
        for (var d = 0; d < c && !(d + b >= a.length || d >= f.length); d++)a[d + b] = f[d];
        return d
      }
      ...
      e._useTypedArrays = function () {
        try {
          var f = new ArrayBuffer(0), a = new Uint8Array(f);
          a.foo = function () {
            return 42
          };
      ...
      e.concat = function (f, a) {
        ...
        if (0 === f.length)return new e(0);
        if (1 === f.length)return f[0];
        var b;
        if ("number" !== typeof a)for (b = a = 0; b < f.length; b++)a += f[b].length;
        var c = new e(a), d = 0;
      ...
      e.prototype.write = function (f, a, b, c) {
        ...
        switch (c) {
          case "hex":
            ...
            b > c / 2 && (b = c / 2);
            for (c = 0; c < b; c++)d = parseInt(f.substr(2 * c, 2), 16), q(!isNaN(d), "Invalid hex string"), this[a + c] = d;
            e._charsWritten = 2 * c;
            f = c;
            break;
          case "utf8":
          ...
          case "utf16le":
          case "utf-16le":
            for (var k, d = [], l = 0; l < f.length; l++)k = f.charCodeAt(l), c = k >> 8, k %= 256, d.push(k), d.push(c);
      ...
      e.prototype.toString = function (f, a, b) {
        ...
        switch (f) {
          ...
          case "utf-8":
            var c = a;
            a = f = "";
            for (b = Math.min(this.length, b); c < b; c++)127 >= this[c] ? (f += G(a) + String.fromCharCode(this[c]), a = "") : a += "%" + this[c].toString(16);
            b = f + G(a);
            break;
          case "ascii":
            b = p(this, a, b);
          ...
          case "utf-16le":
            b =
              this.slice(a, b);
            f = "";
            for (a = 0; a < b.length; a += 2)f += String.fromCharCode(b[a] + 256 * b[a + 1]);
            b = f;
            break;
          default:
            throw Error("Unknown encoding");
      ...
      e.prototype.copy = function (a, b, c, d) {
        ...
        d || 0 === d || (d = this.length);
        b || (b = 0);
        if (d !== c && 0 !== a.length && 0 !== this.length)if (q(d >= c, "sourceEnd < sourceStart"), q(0 <= b && b < a.length, "targetStart out of bounds"), q(0 <= c && c < this.length, "sourceStart out of bounds"),
            q(0 <= d && d <= this.length, "sourceEnd out of bounds"), d > this.length && (d = this.length), a.length - b < d - c && (d = a.length - b + c), d -= c, 100 > d || !e._useTypedArrays)for (var k = 0; k < d; k++)a[k + b] = this[k + c]; else a._set(this.subarray(c, c + d), b)
      };
      e.prototype.slice = function (a, b) {
        var c = this.length;
        a = E(a, c, 0);
        b = E(b, c, c);
        if (e._useTypedArrays)return e._augment(this.subarray(a, b));
        for (var c = b - a, d = new e(c, void 0, !0), k = 0; k < c; k++)d[k] = this[k + a];
        return d
      };
      ...
      e.prototype.readUInt8 = function (a, b) {
        ...
        if (!(a >= this.length))return this[a]
      };
      ...
      e.prototype.writeUInt16LE = function (a,
                                            b, d) {
        c(this, a, b, !0, d)
      };
      ...
      e.prototype.writeInt16LE = function (a,
                                           c, d) {
        b(this, a, c, !0, d)
      };
      ...
      e.prototype.fill = function (a, b, c) {
        ...
        q(c >= b, "end < start");
        if (c !== b && 0 !== this.length)for (q(0 <= b && b < this.length, "start out of bounds"), q(0 <= c && c <= this.length, "end out of bounds"); b < c; b++)this[b] = a
      };
      e.prototype.inspect = function () {
        for (var a = [], b = this.length, c = 0; c < b; c++)if (a[c] = H(this[c]), c === m.INSPECT_MAX_BYTES) {
          a[c + 1] = "...";
          break
        }
    ...
    4: [function (h, r, m) {
      (function (e) {
        function p(e) {
          ...
          if (47 === e)return 63;
          if (48 > e)return -1;
          if (58 > e)return e - 48 + 52;
          if (91 > e)return e - 65;
          if (123 > e)return e - 97 + 26
        }
        ...
        e.toByteArray = function (e) {
          ...
          var b = 0;
          for (d = 0; d < k; d += 4)l = p(e.charAt(d)) << 18 | p(e.charAt(d + 1)) << 12 | p(e.charAt(d + 2)) << 6 | p(e.charAt(d + 3)), g((l & 16711680) >> 16), g((l & 65280) >> 8), g(l & 255);
          2 === c ? (l = p(e.charAt(d)) << 2 | p(e.charAt(d + 1)) >> 4, g(l & 255)) : 1 === c && (l = p(e.charAt(d)) << 10 |
              p(e.charAt(d + 1)) << 4 | p(e.charAt(d + 2)) >> 2, g(l >> 8 & 255), g(l & 255));
          return a
        };
        e.fromByteArray = function (e) {
          var g, d = e.length % 3, k = "", l, c;
          g = 0;
          ...
          switch (d) {
            case 1:
              ...
              break;
            case 2:
              l = (e[e.length - 2] << 8) + e[e.length - 1], k += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(l >> 10), k += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(l >> 4 & 63), k += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(l <<
                2 & 63), k += "="
          }
          return k
        }
    ...
    5: [function (h, r, m) {
      m.read = function (e, p, v, h, g) {
        ...
        if (0 === v) v = 1 - l; else {
          if (v === k)return d ? NaN : Infinity * (b ? -1 : 1);
          d += Math.pow(2, h);
          v -= l
        }
      ...
      m.write = function (e, p, v, h, g, d) {
        var k, l = 8 * d - g - 1, c = (1 << l) - 1, a = c >> 1, b =
          23 === g ? Math.pow(2, -24) - Math.pow(2, -77) : 0;
        d = h ? 0 : d - 1;
        var z = h ? 1 : -1, D = 0 > p || 0 === p && 0 > 1 / p ? 1 : 0;
        p = Math.abs(p);
    ...
    7: [function (h, r, m) {
      (function (e) {
        function h(d, k) {
          ...
          if (k)for (; e--; e)d.unshift("..");
          return d
        }

        function v(d, k) {
          if (d.filter)return d.filter(k);
          for (var e =
            [], c = 0; c < d.length; c++)k(d[c], c, d) && e.push(d[c]);
          return e
        }
        ...
        m.relative = function (d, e) {
          function l(a) {
            ...
            return b > c ? [] : a.slice(b,
                c - b + 1)
          }

          d = m.resolve(d).substr(1);
          e = m.resolve(e).substr(1);
          for (var c = l(d.split("/")), a = l(e.split("/")), b = Math.min(c.length, a.length), g = b, h = 0; h < b; h++)if (c[h] !== a[h]) {
            g = h;
            break
          }
          b = [];
          for (h = g; h < c.length; h++)b.push("..");
        ...
        m.basename = function (d, e) {
          ...
          e && l.substr(-1 * e.length) === e && (l = l.substr(0,
            l.length - e.length));
          return l
        };
    ...
    9: [function (h, r, m) {
      if ("function" !== typeof e)var e = h("amdefine")(r, h);
      e(function (e, h, m) {
        function g() {
          this._array = [];
          this._set = {}
        ...
        g.fromArray = function (d, e) {
          for (var c = new g, a = 0, b = d.length; a < b; a++)c.add(d[a], e);
          return c
        };
        g.prototype.add = function (e,
                                    l) {
          var c = this.has(e), a = this._array.length;
        ...
        g.prototype.indexOf = function (e) {
          if (this.has(e))return this._set[d.toSetString(e)];
          throw Error('"' + e + '" is not in the set.');
        };
        g.prototype.at = function (d) {
          if (0 <= d && d < this._array.length)return this._array[d];
    ...
    10: [function (h, r, m) {
      ...
      e(function (e, h, m) {
        var g = e("./base64");
        h.encode = function (d) {
          var e = "", l = 0 > d ? (-d << 1) + 1 : (d << 1) + 0;
          do d = l & 31, l >>>= 5, 0 < l && (d |= 32), e += g.encode(d); while (0 < l);
          return e
        };
        h.decode = function (d) {
          var e = 0, l = d.length, c = 0, a = 0, b, h;
          do {
            if (e >= l)throw Error("Expected more digits in base 64 VLQ value.");
          ...
          l = c >> 1;
          return {value: 1 === (c & 1) ? -l : l, rest: d.slice(e)}
        }
      })
    },
      {"./base64": 11, amdefine: 17}],
    11: [function (h, r, m) {
      if ("function" !== typeof e)var e = h("amdefine")(r, h);
      e(function (e, h, m) {
        var g = {}, d = {};
    ...
    12: [function (h, r, m) {
      if ("function" !== typeof e)var e =
        h("amdefine")(r, h);
      e(function (e, h, m) {
        function g(d, e, l, c, a) {
          var b = Math.floor((e - d) / 2) + d, h = a(l, c[b], !0);
    ...
    13: [function (h, r, m) {
      ...
      e(function (e, h, m) {
        function g(a) {
          ...
          var c = d.getArg(b, "sources"), e = d.getArg(b,
            "names", []), g = d.getArg(b, "sourceRoot", null), h = d.getArg(b, "sourcesContent", null), k = d.getArg(b, "mappings"), b = d.getArg(b, "file", null);
          if (a != this._version)throw Error("Unsupported version: " + a);
        ...
        var d = e("./util"), k = e("./binary-search"), l = e("./array-set").ArraySet, c = e("./base64-vlq");
        g.fromSourceMap = function (a) {
          var b = Object.create(g.prototype);
          b._names = l.fromArray(a._names.toArray(),
            !0);
        ...
        Object.defineProperty(g.prototype, "sources", {
          get: function () {
            return this._sources.toArray().map(function (a) {
              return this.sourceRoot ? d.join(this.sourceRoot,
                  a) : a
            }, this)
          }
        });
        ...
        Object.defineProperty(g.prototype, "_originalMappings", {
          get: function () {
            this.__originalMappings || (this.__generatedMappings = [], this.__originalMappings = [], this._parseMappings(this._mappings,
              this.sourceRoot));
            return this.__originalMappings
          }
        });
        g.prototype._parseMappings = function (a, b) {
          for (var e = 1, g = 0, l = 0, h = 0, k = 0, y = 0, m = /^[,;]/, t = a, p; 0 < t.length;)if (";" === t.charAt(0)) e++, t = t.slice(1), g = 0; else if ("," === t.charAt(0)) t = t.slice(1); else {
            p = {};
            p.generatedLine = e;
            t = c.decode(t);
            ...
            if (0 < t.length && !m.test(t.charAt(0))) {
              ...
              k += t.value;
              t = t.rest;
              if (0 === t.length || m.test(t.charAt(0)))throw Error("Found a source, but no line and column");
              t = c.decode(t);
              p.originalLine = l + t.value;
              l = p.originalLine;
              p.originalLine += 1;
              t = t.rest;
              if (0 === t.length || m.test(t.charAt(0)))throw Error("Found a source and line, but no column");
              t = c.decode(t);
        ...
        g.prototype._findMapping = function (a, b, c, d, e) {
          if (0 >= a[c])throw new TypeError("Line must be greater than or equal to 1, got " + a[c]);
          if (0 > a[d])throw new TypeError("Column must be greater than or equal to 0, got " + a[d]);
          return k.search(a, b, e)
        };
        g.prototype.originalPositionFor = function (a) {
          a = {generatedLine: d.getArg(a, "line"), generatedColumn: d.getArg(a, "column")};
          if (a = this._findMapping(a, this._generatedMappings, "generatedLine", "generatedColumn",
              d.compareByGeneratedPositions)) {
        ...
        g.prototype.sourceContentFor = function (a) {
          ...
          if (this._sources.has(a))return this.sourcesContent[this._sources.indexOf(a)];
          var b;
        ...
        g.prototype.generatedPositionFor = function (a) {
          a = {source: d.getArg(a, "source"), originalLine: d.getArg(a, "line"), originalColumn: d.getArg(a, "column")};
          this.sourceRoot &&
          (a.source = d.relative(this.sourceRoot, a.source));
    ...
    }, {"./array-set": 9, "./base64-vlq": 10, "./binary-search": 12, "./util": 16, amdefine: 17}],
    14: [function (h, r, m) {
      if ("function" !== typeof e)var e = h("amdefine")(r, h);
      e(function (e, h, m) {
        function g(c) {
        ...
        var d = e("./base64-vlq"), k = e("./util"), l = e("./array-set").ArraySet;
        g.prototype._version = 3;
        g.fromSourceMap = function (c) {
          var a = c.sourceRoot, b = new g({file: c.file, sourceRoot: a});
          c.eachMapping(function (c) {
            var d = {generated: {line: c.generatedLine, column: c.generatedColumn}};
        ...
        g.prototype.addMapping = function (c) {
          var a = k.getArg(c, "generated"), b = k.getArg(c, "original", null), d = k.getArg(c, "source", null);
          ...
          this._mappings.push({
            generatedLine: a.line, generatedColumn: a.column, originalLine: null != b && b.line, originalColumn: null !=
            b && b.column, source: d, name: c
          })
        };
        ...
        g.prototype.applySourceMap = function (c, a) {
          ...
          this._mappings.forEach(function (g) {
            if (g.source ===
              a && g.originalLine) {
              var l = c.originalPositionFor({line: g.originalLine, column: g.originalColumn});
        ...
        g.prototype._validateMapping =
          function (c, a, b, d) {
            if (!(c && "line" in c && "column" in c && 0 < c.line && 0 <= c.column && !a && !b && !d || c && "line" in c && "column" in c && a && "line" in a && "column" in a && 0 < c.line && 0 <= c.column && 0 < a.line && 0 <= a.column && b))throw Error("Invalid mapping: " + JSON.stringify({
                generated: c,
                source: b,
                original: a,
                name: d
        ...
        g.prototype._serializeMappings = function () {
          var c = 0, a = 1, b = 0, e = 0, g = 0, l = 0, h = "", w;
          this._mappings.sort(k.compareByGeneratedPositions);
          for (var y = 0, p = this._mappings.length; y < p; y++) {
            w = this._mappings[y];
            if (w.generatedLine !== a)for (c =
                                             0; w.generatedLine !== a;)h += ";", a++; else if (0 < y) {
              if (!k.compareByGeneratedPositions(w, this._mappings[y - 1]))continue;
              h += ","
            }
        ...
        g.prototype._generateSourcesContent = function (c,
                                                        a) {
        ...
        g.prototype.toJSON = function () {
          ...
          this._sourcesContents && (c.sourcesContent = this._generateSourcesContent(c.sources,
            c.sourceRoot));
          return c
        };
    ...
    }, {"./array-set": 9, "./base64-vlq": 10, "./util": 16, amdefine: 17}],
    15: [function (h, r, m) {
      if ("function" !== typeof e)var e = h("amdefine")(r, h);
      e(function (e, h, m) {
        ...
        g.fromStringWithSourceMap = function (d, c) {
          ...
          var b = new g, e = d.split("\n"), h = 1, k = 0, p = null;
          c.eachMapping(function (c) {
            if (null === p) {
              for (; h < c.generatedLine;)b.add(e.shift() + "\n"), h++;
              ...
              } else d = e[0], g = d.substr(0, c.generatedColumn - k), e[0] = d.substr(c.generatedColumn - k), k = c.generatedColumn;
              a(p, g)
            }
            p = c
          }, this);
        ...
        g.prototype.add = function (d) {
          if (Array.isArray(d)) d.forEach(function (c) {
            this.add(c)
          }, this); else if (d instanceof g || "string" === typeof d) d &&
          this.children.push(d); else throw new TypeError("Expected a SourceNode, string, or an array of SourceNodes and strings. Got " + d);
          return this
        };
        g.prototype.prepend = function (d) {
          if (Array.isArray(d))for (var c = d.length - 1; 0 <= c; c--)this.prepend(d[c]); else if (d instanceof g || "string" === typeof d) this.children.unshift(d); else throw new TypeError("Expected a SourceNode, string, or an array of SourceNodes and strings. Got " + d);
          return this
        };
        g.prototype.walk = function (d) {
          for (var c, a = 0, b = this.children.length; a < b; a++)c =
            this.children[a], c instanceof g ? c.walk(d) : "" !== c && d(c, {
              source: this.source,
              line: this.line,
              column: this.column,
              name: this.name
        ...
        g.prototype.join = function (d) {
          var c, a, b = this.children.length;
          if (0 < b) {
            c = [];
            for (a = 0; a < b - 1; a++)c.push(this.children[a]), c.push(d);
        ...
        g.prototype.replaceRight = function (d, c) {
          ...
          a instanceof g ? a.replaceRight(d, c) : "string" === typeof a ? this.children[this.children.length - 1] = a.replace(d, c) : this.children.push("".replace(d,
                c));
          return this
        };
        ...
        g.prototype.walkSourceContents = function (d) {
          for (var c = 0, a = this.children.length; c < a; c++)this.children[c] instanceof g && this.children[c].walkSourceContents(d);
          for (var b = Object.keys(this.sourceContents), c = 0, a = b.length; c < a; c++)d(k.fromSetString(b[c]), this.sourceContents[b[c]])
        };
        g.prototype.toString = function () {
          var d = "";
        ...
        g.prototype.toStringWithSourceMap = function (e) {
          var c =
            "", a = 1, b = 0, g = new d(e), h = !1, k = null, p = null, w = null, m = null;
          this.walk(function (d, e) {
            ...
            null !== e.source && null !== e.line && null !== e.column ? (k === e.source && p === e.line && w === e.column && m === e.name || g.addMapping({
                ...
                generated: {line: a, column: b},
                name: e.name
              }), k = e.source, p = e.line, w = e.column, m = e.name, h = !0) : h && (g.addMapping({
                generated: {
                  line: a,
                  column: b
                }
    ...
    }, {"./source-map-generator": 14, "./util": 16, amdefine: 17}],
    16: [function (h, r, m) {
      if ("function" !== typeof e)var e = h("amdefine")(r, h);
      e(function (e, h, m) {
        function g(a) {
        ...
        h.relative = function (a, b) {
          a = a.replace(/\/$/, "");
          var c = g(a);
          return "/" == b.charAt(0) && c && "/" == c.path ?
            b.slice(1) : 0 === b.indexOf(a + "/") ? b.substr(a.length + 1) : b
        };
        ...
        h.compareByGeneratedPositions = function (a, b, c) {
          var d;
          return (d = a.generatedLine - b.generatedLine) || (d = a.generatedColumn - b.generatedColumn) || c || (d = k(a.source, b.source)) || (d = a.originalLine - b.originalLine) ?
            d : (d = a.originalColumn - b.originalColumn) ? d : k(a.name, b.name)
        }
      })
    }, {amdefine: 17}],
    17: [function (h, r, m) {
        ...
        r.exports = function (m, r) {
          function g(a, b) {
            ...
            if (a && "." === a.charAt(0) && b) {
              ...
              var d = c = c.concat(a.split("/")), e, g;
              for (e = 0; d[e]; e += 1)if (g = d[e], "." === g) d.splice(e, 1), --e; else if (".." === g)if (1 !== e || ".." !== d[2] && ".." !== d[0]) 0 < e && (d.splice(e - 1, 2), e -= 2); else break;
              a = c.join("/")
            }
            return a
          }
          ...
          function l(a, c, d) {
            var e, g, h;
            if (a) g = b[a] = {}, h = {id: a, uri: p, exports: g}, e = B(r, g, h, a); else {
              if (z)throw Error("amdefine with no module ID cannot be called more than once per file.");
              z = !0;
              g = m.exports;
              h = m;
              e = B(r, g, h, m.id)
          ...
          var a = {}, b = {}, z = !1, D = h("path"), B, E;
          B = function (a, b, c, d) {
            function h(g, k) {
              if ("string" === typeof g)return E(a, b, c, g, d);
              g = g.map(function (e) {
                return E(a, b, c, e, d)
              });
              e.nextTick(function () {
          ...
          E = function (c, e, h, m, p) {
            ...
            if (-1 === r) {
              m = g(m, p);
              if ("require" === m)return B(c, e, h, p);
              if ("exports" === m)return e;
              if ("module" === m)return h;
              if (b.hasOwnProperty(m))return b[m];
              if (a[m])return l.apply(null, a[m]), b[m];
              if (c)return c(G);
          ...
          c.require = function (c) {
            if (b[c])return b[c];
            if (a[c])return l.apply(null, a[c]), b[c]
          };
          c.amd = {};
          return c
        }
      }).call(this,
        h("node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js"), "/node_modules/source-map/node_modules/amdefine/amdefine.js")
    }, {"node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js": 6, path: 7}],
    18: [function (h, r, m) {
      (function (e, p) {
        function r() {
        ...
        function g(a, b) {
          if (!a)return b;
          var c = w.dirname(a), d = /^\w+:\/\/[^\/]*/.exec(c), d = d ? d[0] : "";
        ...
        function d(a) {
          var b;
          a:{
            if (r() && (b = new XMLHttpRequest, b.open("GET", a, !1), b.send(null), b = b.getResponseHeader("SourceMap") || b.getResponseHeader("X-SourceMap")))break a;
            b = A(a);
            b = (b = /\/\/[#@]\s*sourceMappingURL=(.*)\s*$/m.exec(b)) ? b[1] : null
          }
          if (!b)return null;
          "data:application/json;base64," == b.slice(0,
            29).toLowerCase() ? (a = (new p(b.slice(29), "base64")).toString(), b = null) : (b = g(a, b), a = A(b, "utf8"));
          return a ? {url: b, map: a} : null
        }
        ...
        function c() {
          ...
          var c = this.getFunctionName(),
            d = !0, e = this.isConstructor();
          if (this.isToplevel() || e) e ? a += "new " + (c || "<anonymous>") : c ? a += c : (a += b, d = !1); else {
            var e = this.getTypeName(), g = this.getMethodName();
        ...
        function b(b) {
          ...
          if (c) {
            var d = k({source: c, line: b.getLineNumber(), column: b.getColumnNumber() - 1});
            b = a(b);
        ...
        function B(a) {
          if (a && a.stack) {
            ...
            console.log(a.stack)
          } else console.log("Uncaught exception:", a);
          e.exit(1)
        }

        var E = h("source-map").SourceMapConsumer, w = h("path"), y = h("fs"), H = !1, t = !1, F = {}, C =
          {};
        m.wrapCallSite = b;
        m.getErrorSource = D;
        ...
        m.install = function (a) {
          if (!H) {
            ...
            if (b && !r()) e.on("uncaughtException", B)
          }
        }
      }).call(this, h("node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js"),
        h("buffer").Buffer)
